...
public class Scene2 extends JPanel {
    ...
    private TransformationStatic worldToCamera;
    private TransformationStatic worldTransformation;
...

    {
        ...
        worldTransformation = TransformationStatic.identity();
    }
    ...
    class MouseHandler extends MouseAdapter implements MouseMotionListener,
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            TransformationStatic t = TransformationStatic.identity();

            t.compose(TransformationStatic.translate(-boxOrigin.getX(),
                    -boxOrigin.getY(), -boxOrigin.getZ()));
            t.compose(TransformationStatic.rotate(dx, TransformationStatic.Y_AXIS));
            t.compose(TransformationStatic.rotate(dy, TransformationStatic.X_AXIS));
            t.compose(TransformationStatic.translate(boxOrigin.getX(),
                    boxOrigin.getY(), boxOrigin.getZ()));
        ...
        public void mouseWheelMoved(MouseWheelEvent e) {
            ...
            TransformationStatic t = TransformationStatic.translate(
    ...
    private void initBoundBox() {
        ...
        double boxX = (maxX + minX) / 2,
                boxY = (maxY + minY) / 2,
                boxZ = (maxZ + minZ) / 2;
        box = Wireframe.box(maxX - minX, maxY - minY, maxZ - minZ);
    ...
    private void initCamera() {
        ...
        worldToCamera = TransformationStatic.translate(-cameraX, -cameraY, -cameraZ);
    ...
    protected void paintComponent(Graphics g1) {
        ...
        TransformationStatic projection = TransformationStatic.perspective(-halfWidth,
                halfWidth, -halfHeight, halfHeight, znear, zfar);

        TransformationStatic t = TransformationStatic.compose(worldToCamera, worldTransformation);
