...
public class CoordinateSystem {
    ...
    /**
     * Default constructor; origin at (0,0,0) and vectors are (1,0,0) (0,1,0)
     * (0,0,1)
     */
    ...
    public CoordinateSystem(Vertex origin) {
        this(origin, new Vector(1, 0, 0), new Vector(0, 1, 0), new Vector(0, 0,
                1));
    }
    ...
    private void checkBasis() {
        ...
        double v1x = v1.getX(), v2x = v2.getX(), v3x = v3.getX(), v1y = v1.getY(), v2y = v2.getY(), v3y = v3.getY(), v1z = v1.getZ(), v2z = v2.getZ(), v3z = v3.getZ();
        ...
        double v1v2Product = v1x * v2x + v1y * v2y + v1z * v2z, v1v3Product = v1x
                * v3x + v1y * v3y + v1z * v3z, v2v3Product = v2x * v3x + v2y
                * v3y + v2z * v3z;

        double det = v1x * (v2y * v3z - v3y * v2z) - v2x
                * (v1y * v3z - v3y * v1z) + v3x * (v1y * v2z - v2y * v1z);
        ...
        if (det < 0) {
            throw new IllegalArgumentException(
                    "Right-hand coordinate system expected");
        }
    ...
    public void setBasis(Vector v1, Vector v2, Vector v3) {
        Vector v1Old = this.v1, v2Old = this.v2, v3Old = this.v3;
     ...
     */
    public Transformation getFrameToWorldTransformation() {

        Transformation frameToCanonicalTransformation = new FrameToWorldTransformation(
                v1, v2, v3, origin);
