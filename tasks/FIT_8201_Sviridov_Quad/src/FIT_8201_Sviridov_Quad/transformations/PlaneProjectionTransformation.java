...
public class PlaneProjectionTransformation extends TransformationMatrixImpl {
    ...
    public static PlaneProjectionTransformation makePlaneProjectionTransformation(Vector n) {
        n = n.normalize();
        double a = n.getX(), b = n.getY(), c = n.getZ();
        double d = a * a + b * b + c * c;
        return new PlaneProjectionTransformation(
                1 - a * a / d, a * b / d, a * c / d, 0,
                a * b / d, 1 - b * b / d, b * c / d, 0,
                a * c / d, b * c / d, 1 - c * c / d, 0,
                0, 0, 0, 1);
    }

    private PlaneProjectionTransformation(double m11, double m12, double m13, double m14,
