...
public class CoordinateSystem {
	...
	private void checkBasis() {
		...
		double v1x = v1.getX(), v2x = v2.getX(), v3x = v3.getX(), v1y = v1
				.getY(), v2y = v2.getY(), v3y = v3.getY(), v1z = v1.getZ(), v2z = v2
				.getZ(), v3z = v3.getZ();
	...
	public Transformation getFrameToCanonicalTransformation() {
		...
		Transformation frameToCanonicalTransformation = new Transformation(v1x,
				v2x, v3x, ox, v1y, v2y, v3y, oy, v1z, v2z, v3z, oz, 0, 0, 0, 1);
