...
public final class Frame extends MainFrame {
    ...
    class SettingsDialog extends JDialog {
        ...
        private JSpinner znSpinner = new JSpinner(new SpinnerNumberModel(0, 0, 4000, 10));
        private JSlider zfSlider = new JSlider(0, 4000);
        private JSpinner zfSpinner = new JSpinner(new SpinnerNumberModel(0, 0, 4000, 10));
        private JSlider rSlider = new JSlider(0, 100);
        private JSpinner rSpinner = new JSpinner(new SpinnerNumberModel(0.01, 0.0, 1.0, 0.01));
        private JSlider dSlider = new JSlider(0, 100);
        private JSpinner dSpinner = new JSpinner(new SpinnerNumberModel(0, 0, 100, 1));
         ...
         */
        public void confirm() {
            int znear = (Integer) znSpinner.getValue(),
                    zfar = (Integer) zfSpinner.getValue();
            if (zfar <= znear) {
                JOptionPane.showMessageDialog(this, "zFar must be more than zNear", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
         ...
         * @return new subpanel
         */
        private JPanel makeSubPanel(String title, JSlider slider, JSpinner spinner) {
    ...
    public Frame(int width, int height) {
        ...
        try {
            ...
            addMenuItem("Edit/Init", "Init scene", KeyEvent.VK_I,
                    "init.gif", "onInit");
            addMenuItem("Edit/Show or hide orts", "Show/hide orts", KeyEvent.VK_O,
                    "orts.gif", "onOrts");
            addMenuItem("Edit/Show or hide box", "Show/hide box", KeyEvent.VK_B,
                    "box.gif", "onBox");
            addMenuItem("Edit/Show or hide objects", "Show/hide objects", KeyEvent.VK_S,
                    "obj.gif", "onObjects");
