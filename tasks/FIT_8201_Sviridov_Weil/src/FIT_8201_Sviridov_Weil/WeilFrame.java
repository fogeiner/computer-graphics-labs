...
public class WeilFrame extends MainFrame implements FrameService {
	...
	/**
	 * Blocks save and intersect toolbar buttons/menu entries
	 * 
	 * @param value
	 *            new value
	 */
	...
	/**
	 * Sets modified flag to <code>value</code>
	 * 
	 * @param value
	 *            new value
	 */
	...
	/**
	 * Returns value of the modified flag
	 * 
	 * @return value of the modified flag
	 */
	@Override
