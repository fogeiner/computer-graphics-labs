...
public class ImageNavigationPanel extends ImagePanel {
	...
	public ImageNavigationPanel(String title,
		...
		class MouseHandler extends MouseAdapter {
			...
			private void updateSelection(MouseEvent e) {
				...
				// + " left_upper_x: " + left_upper_x + " left_upper_y: " +
				// left_upper_y + " right_lower_x: " + right_lower_x
				// + " right_lower_y: " + right_lower_y + " selection_x: " +
				// _selection_x + " selection_y: " + _selection_y);
	...
	public void setImage(BufferedImage img) {
		...
		if (img_width > panel_width && img_height > panel_height) {
			...
			// System.out.println("Image after scaling: " +
			// _display_img.getWidth(null) + "x" +
			// _display_img.getHeight(null));
			...
			// double ratio = (double) _display_img.getHeight(null) /
			// img_height;
			_selection_width = (int) ((double) panel_width
					* _display_img.getWidth(null) / img_width + 0.5);
			_x_ratio = (double) img_width / _display_img.getWidth(null);
		...
		// System.out.println("image width: " + img_width + " image height: " +
		// img_height
		// + "\nselection_width: " + _selection_width + " selection height: " +
		// _selection_height
		// + "\nx_ratio: " + _x_ratio + " y_ratio: " + _y_ratio
		// + "\nsel_widx_ratioth*x_ratio: " + _selection_width * _x_ratio +
		// " sel_height*y_ratio: " + _selection_height * _y_ratio);
