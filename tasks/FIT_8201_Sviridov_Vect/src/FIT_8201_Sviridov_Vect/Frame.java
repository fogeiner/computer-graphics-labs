...
public final class Frame extends MainFrame implements StateHistoryListener,
	...
	public Frame(int width, int height) {
		...
		try {
			...
			addMenuItem("Edit/Switch field mode",
					"Invert field mode (B&W vs color)", KeyEvent.VK_B,
					"bw_arrows.gif", "onBWField");
			addMenuItem("Edit/Switch arrow mode",
					"Invert arrow mode (plain vs filled)", KeyEvent.VK_F,
